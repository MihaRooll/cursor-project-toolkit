...
> Паттерн из OpenAI GPT-5.6 guidance ([SRC-012](../SOURCES.md)). Для Cursor-агентов и product prompts.
...
- [docs/openai-gpt56-model-guidance.md](../docs/openai-gpt56-model-guidance.md)
- [plan-then-build.md](plan-then-build.md) · `constraint-first.md` (Full mode only)
