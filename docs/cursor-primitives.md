...
> **AI-first.** Источники: [SRC-006](../SOURCES.md) — [Rules](https://cursor.com/docs/rules) · [Skills](https://cursor.com/docs/skills).
...
https://cursor.com/docs/rules · https://cursor.com/docs/skills · [SRC-006](../SOURCES.md)
