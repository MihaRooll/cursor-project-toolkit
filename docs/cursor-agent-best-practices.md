...
> **AI-first.** Источник: [SRC-005](../SOURCES.md) — [Best practices for coding with agents](https://cursor.com/blog/agent-best-practices).
...
https://cursor.com/blog/agent-best-practices · [SRC-005](../SOURCES.md)
