...
- T0: Main Work Packet → Composer implementer → targeted checks; no plan artifact.
- T1: Main Work Packet → Composer → Grok verifier; mechanical multi-file may stay T1.
...
- Main never product-writes T0–T3.
