...
**Wave 4 truth:** strict hook templates and living-eval ship in **Full only**; never in Essential, never in plugin. Promotion: [harness-evidence-and-enforcement.md](harness-evidence-and-enforcement.md) + `/review-harness-evidence` (toolkit-only skill).
...
|-------|-------|-----------|------|
| Authority ladder, Obsidian vault | [memory-and-obsidian.md](memory-and-obsidian.md) | no (link here) | yes |
| ReMe opt-in index | [reme-agent-memory.md](reme-agent-memory.md) | note | yes |
| MCP security, placement, pins | [mcp-security.md](mcp-security.md) | no | yes |
...
- [harness-evidence-and-enforcement.md](harness-evidence-and-enforcement.md)
- [bootstrap-scaffold.md](bootstrap-scaffold.md)
- [harness-as-cursor-plugin.md](harness-as-cursor-plugin.md)
